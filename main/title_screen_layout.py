...
layout_ingame = "ingame"

def is_paused(current_menu):
    return layout_ingame in current_menu and current_menu != layout_ingame

# This is what menu screen happens when the pause button is pressed while playing
layout_pausedgame = "ingame/pausemenu"

# This is what menu screen happens when the game boots up
layout_default = "ingame"
